...
output = Conv2D(2, 1, padding='same', activation='softmax', name='output')(pre_output)
...
modelUNet.compile(optimizer=opt, loss=weighted_dice(dice_loss_function, weights_list), metrics=[dice_function])
